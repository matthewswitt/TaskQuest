...
/**
 * Precompiled taskquest.kotlin-library-conventions script plugin.
 **/
public class TaskquestKotlinLibraryConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_TaskquestKotlinLibraryConventions").asSubclass(BasicScript.class);
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_TaskquestKotlinLibraryConventions").asSubclass(BasicScript.class);

...
/**
 * Precompiled taskquest.kotlin-application-conventions script plugin.
 **/
public class TaskquestKotlinApplicationConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_TaskquestKotlinApplicationConventions").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("taskquest.kotlin-common-conventions");
            target.getPluginManager().apply("application");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_TaskquestKotlinApplicationConventions").asSubclass(BasicScript.class);
